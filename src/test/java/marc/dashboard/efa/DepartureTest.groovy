...
class DepartureTest extends Specification {
    def "calculating countdown"() {
        setup:
        def departure = new Departure(100, "some station", "some direction", departureTime, departureTime)
        ...
        departureTime    | time             | expectedCountdown
        time("11:00:00") | time("11:00:00") | 0
        time("11:00:00") | time("11:00:31") | 0
        time("11:01:00") | time("11:00:00") | 1
        time("11:01:00") | time("11:00:31") | 0
        time("11:02:00") | time("11:00:31") | 1
        time("11:02:00") | time("11:00:29") | 2
        time("12:00:00") | time("11:00:00") | 60
    }
